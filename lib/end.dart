...
import 'package:invoice/rd.dart';
...
class _InvoiceScreenState extends State<InvoiceScreen> {
  ...
  Future<Uint8List> generatePdf(List<InvoiceItem> invoiceItems, double taxRate, double subtotal, double total) async {
    ...
    pw.SizedBox(height: 20),
    pw.Table(
    defaultVerticalAlignment: pw.TableCellVerticalAlignment.middle,                columnWidths: { 0: pw.FlexColumnWidth(1), 1: pw.FlexColumnWidth(4), 2:pw.FlexColumnWidth(1.7), 3:pw.FlexColumnWidth(2.4)},
    ...
    pw.Padding(
    padding: pw.EdgeInsets.all(10),child: pw.Center(
